...
| `npm run test:e2e` | PASS | 7 Playwright tests in Chromium, 10.9 seconds |

The Playwright smoke suite covers campaign completion and reload persistence, pause/resume, extended timing settings, and pre-commit protection against outcome-only information leaking into the DOM for levels 102, 115, 184, and 195.
